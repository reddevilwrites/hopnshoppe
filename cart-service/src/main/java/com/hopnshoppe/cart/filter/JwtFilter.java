package com.hopnshoppe.cart.filter;
 ...
 * When {@code X-User-Id} is absent, falls back to validating the
 * {@code Authorization: Bearer} JWT directly for defence-in-depth.
 * Cart-service remains secure even if the gateway is bypassed inside the cluster.
 */
